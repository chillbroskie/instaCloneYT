      ...
      >
        <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-28 text-center sm:block sm:p-0">
          ...
          <Transition.Child
            ...
            enterTo="opacity-100 translate-y-100 sm:scale-100"
            leave="ease-in duration-200"
              ...
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  <button 
                    ...
                    bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2
                    focus:ring-blue-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed disabled:hover:bg-gray-300"
                    onClick={uploadPost}
                  >
